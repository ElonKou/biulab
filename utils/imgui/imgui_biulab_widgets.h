...
IMGUI_API void DrawFlag(ImDrawList* draw_list, ImVec2& p0, ImVec2& p1, ImVec4& color);
IMGUI_API void DrawDoor(ImDrawList* draw_list, ImVec2& p0, ImVec2& p1, ImVec4& color);
